...
export default function RundownAuth() {
  ...
  return (
    <div
      className="rd-root min-h-screen flex items-center justify-center px-4"
      style={{ background: "#F0F1EC" }}
    >
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <span
            className="rd-display text-2xl font-semibold"
            style={{ color: "#1C2430" }}
          >
            Rundown
          </span>
        ...
        <div
          className="rd-line rounded-lg p-7"
        ...
        >
          ...
          <p className="text-sm mb-6" style={{ color: "#5B6472" }}>
            {mode === "login"
              ? "Connectez-vous pour retrouver votre rundown."
              : "Commencez à publier plus, en gérant moins."}
          </p>
          ...
          <form onSubmit={handleSubmit} noValidate>
            {mode === "signup" && (
              <div className="mb-4">
                ...
                />
                {errors.name && (
                  <p className="text-xs mt-1" style={{ color: "#B5452F" }}>
                    {errors.name}
                  </p>
                )}
              </div>
            ...
            {mode === "signup" && (
              <div className="mb-5">
                ...
                <input
                  ...
                  className="rd-input w-full rd-line rounded px-3 py-2 text-sm"
                  style={
                    errors.confirm ? { borderColor: "#B5452F" } : undefined
                  }
                  placeholder="••••••••"
                />
                {errors.confirm && (
